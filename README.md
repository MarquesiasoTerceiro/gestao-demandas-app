...
2. Abra o site e entre com seu usuario. Na primeira entrada, cole o token na tela. Por padrao, ele fica no `localStorage` deste navegador para funcionar em outras abas; desmarque a opcao para limitar o token ao `sessionStorage` daquela aba. O token nao e incluído nos arquivos do site.
